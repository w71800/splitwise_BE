...
export interface ApiRecordRecord extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currency: Schema.Attribute.Enumeration<['TWD', 'USD', 'JPY']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'TWD'>;
    divisions: Schema.Attribute.Component<'record-entries.division', true>;
    fullDate: Schema.Attribute.Date & Schema.Attribute.Required;
    group: Schema.Attribute.Relation<'manyToOne', 'api::group.group'>;
    isSettlement: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::record.record'
    > &
      Schema.Attribute.Private;
    participants: Schema.Attribute.Component<
      'record-entries.participant',
      true
    > &
      Schema.Attribute.Required;
    payers: Schema.Attribute.Component<'record-entries.payer', true> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    splitor: Schema.Attribute.Enumeration<
      ['equal', 'fixed', 'percentage', 'ratio']
    > &
      Schema.Attribute.Required &
